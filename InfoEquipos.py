...
def InfoEquipos(partidos,equipos):
    ...
    for equipo in equipos:
        ...
        for partido in partidos:
            ...
            #local:
            if partido["Team 1"]==equipo and QuienGana.QuienGana(partido["FT"])==0:
                obtenido[2]+=1 #empate
            elif partido["Team 1"]==equipo and QuienGana.QuienGana(partido["FT"])==-1:
            ...
            #visitante:
            if partido["Team 2"]==equipo and QuienGana.QuienGana(partido["FT"])==0:
                obtenido[2]+=1 #empate
            elif partido["Team 2"]==equipo and QuienGana.QuienGana(partido["FT"])==-1:
                obtenido[1]+=1  #derrota
            elif partido["Team 2"]==equipo and QuienGana.QuienGana(partido["FT"])==1:
                obtenido[0]+=1  #victoria
